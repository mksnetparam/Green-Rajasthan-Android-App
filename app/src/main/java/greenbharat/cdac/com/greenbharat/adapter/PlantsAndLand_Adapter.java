...
import greenbharat.cdac.com.greenbharat.activity.PlantGrowthChechingActivity;
 ...
 */
public class PlantsAndLand_Adapter extends RecyclerView.Adapter<PlantsAndLand_Adapter.ContactViewHolder> {

    private ArrayList<PlantsAndLand_pojo> plantsAndLand_pojos = new ArrayList<PlantsAndLand_pojo>();
    private Context context;
    private String img_prefix;

    public PlantsAndLand_Adapter(Context context, ArrayList<PlantsAndLand_pojo> plantsAndLand_pojos, String img_prefix) {
    ...
    public void onBindViewHolder(ContactViewHolder holder, int position) {
        ...
        holder.adopter_name.setText(plantsAndLand_pojo.getNominee_name());
        ...
        holder.card_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, PlantGrowthChechingActivity.class);
